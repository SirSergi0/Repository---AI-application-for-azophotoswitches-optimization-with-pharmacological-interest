...
\begin{itemize}
\item General consultes \href{tel:93 580 9570}{+34 93 580 9570}
\item \href{https://www.iiia.csic.es/en-us/people/person/?person_id=39}{Pablo Noriega}: \href{mailto:pablo@iiia.csic.es}{pablo@iiia.csic.es}
\end{itemize}
Chemistry department - UAB:
\begin{itemize}
\item Àngels Gonzàlez Lafont: \href{mailto:angels.gonzalez@uab.cat}{angels.gonzalez@uab.cat}
\item Miquel Moreno Ferrer: \href{mailto:miquel.moreno@uab.cat}{miquel.moreno@uab.cat}
\end{itemize}
Me:
\begin{itemize}
\item Sergio Castañeiras Morales: \href{mailto:1598456@uab.cat}{1598456@uab.cat}
\end{itemize}
